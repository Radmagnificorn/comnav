...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DisplayControl = __webpack_require__(34);
	...
	var displayControl = new _DisplayControl2.default(comicPanel, dispProps);
	var pageManager = new _PageManager2.default('./pages', 'chapter1');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChapterLoader = __webpack_require__(33);

	var _ChapterLoader2 = _interopRequireDefault(_ChapterLoader);
	...
	var PageManager = function () {
	    function PageManager(baseDir, chapterUrl) {
	    ...
	    _createClass(PageManager, [{
	        ...
	        key: 'loadChapter',
	        value: function loadChapter(chapterUrl) {
	            var _this = this;

	            _ChapterLoader2.default.loadChapterManifest(this.baseDir + "/" + chapterUrl).then(function (manifest) {
...
/***/ function(module, exports) {
	...
	var ChapterLoader = function () {
	    function ChapterLoader() {
	        _classCallCheck(this, ChapterLoader);
	    }

	    _createClass(ChapterLoader, null, [{
